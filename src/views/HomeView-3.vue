      ...
      <div class="scroll-panel">
        <myScroll>
          <div class="scroll-content" v-for="(item,i) in propinsi" :key="i">
            <div class="propinsi">
              <span style="font-size: 10px;"><i v-on:click="subPropinsiClick"
                  :class="{ 'icon-arrow-up': subPropinsiShow, 'icon-arrow-down': !subPropinsiShow, }"
      ...
      <div class="page-content" :class="{ 'topbar-sidebar-enable': sidebar_show }">
        <div class="container">
          <div class="col-desc" v-if="colDescShow">
            ...
            <myScroll>
              ...
              <div class="col-desc-close">
                <i class="icon-close" v-on:click="colDescShow = !colDescShow"
                  style="margin-top: 3px;font-size: 22px; cursor:pointer"></i>
              </div>
              ...
              <div class="panel-right-content">
                ...
                <k-tabs>
                  <k-tab name="PROGRESS" :selected="true">
                    ...
                    <div v-for="(item, x) in data_pembibitan"  :key="x">
                      <div class="content-area">
                        ...
                        <div class="answer-content"> {{ item.jml_bibit | numberFormat }}</div>
                      </div>
                    </div>
                    <div class="content-area" style="margin-top:5px;">
                      <div class="label-content">Total Bibit :</div>
                      <div class="answer-content"> {{jml_bibit | numberFormat}}</div>
                    </div>
                    <div class="content-area">
                      <div class="label-content"> Total Luas Lahan :</div>
                      <div class="answer-content"> {{ luas_lahan | numberFormat }} m2</div>
                    </div>
                    ...
                    <div class="content-area">
                      <div class="label-content"> <i class="icon-arrow-right"
                          style="margin-right:3px;font-size: 10px;"></i>Bambu Petung :</div>
                      <div class="answer-content"> 200</div>
                    </div>
                    <div class="content-area">
                      <div class="label-content"> <i class="icon-arrow-right"
                          style="margin-right:3px;font-size: 10px;"></i>Bambu Aur :</div>
                      <div class="answer-content"> 500</div>
                    </div>
                    <div class="content-area">
                      <div class="label-content"> <i class="icon-arrow-right"
                          style="margin-right:3px;font-size: 10px;"></i>Bambu Pering :</div>
                      <div class="answer-content"> 1500</div>
                    </div>
                    <div class="content-area">
                      <div class="label-content"> Total Luas Lahan :</div>
                      <div class="answer-content"> 5.3 Ha</div>
                    </div>
                  </k-tab>
                  ...
                  <k-tab name="DETAIL PEMBIBIT">
                    ...
                    <ul>
                      <li v-for="(item,i) in data_pembibit" :key="i">
                        {{ item }}
                        <ul>
                          <li v-for="(subitem, x) in getDetailBibitPembibit(item)" :key="x">
                    ...
                    <div>Total : {{ total_pembibit | numberFormat }} pembibit</div>
                  </k-tab>
                  ...
                  <k-tab name="NEWS">
                    ...
                    kabupaten/kota. Provinsi ini berada di Sunda Kecil.[7][8] Tahun 2020, penduduk provinsi ini
                    berjumlah 5.325.566 jiwa, dengan kepadatan 111 jiwa/km2.[2]
                  </k-tab>
                </k-tabs>
          ...
          <div class="inner-content">
            ...
            <div id="mapContainer">
              <div class="map-layer" v-on:click="viewLayer = !viewLayer"><img src="../../public/img/layers-icon.png" class="layer-icon"/></div>
            </div>
      ...
      if (detail_pembibit.length > 0) {
        for(let i = 0; i < detail_pembibit.length; i++){ 
          if (detail_pembibit[i]['nama_peserta'] != nama_pembibit) {
            ...
            dataPembibit.push(detail_pembibit[i]['nama_peserta'])
          }
        }
      }
      return dataPembibit
...
console.log(this.desa_bambu)
    ...
    markDesaBambuClick(f, l, center) {
      ...
      this.menuDesaClick(desa.line, 13)
    },
