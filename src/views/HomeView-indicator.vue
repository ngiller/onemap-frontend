          ...
          <div class="col-desc" v-if="colDescShow">
            ...
            <myScroll>
              ...
              <div class="panel-right-content">
                ...
                <div>
                  Desa Persiapan Bangka Wela telah dilakukan penjajakan (assesment dan sosialiasi) terkait program 1000 desa bambu. 
                ...
                <badger-accordion :icons="{opened: '<i class=icon-arrow-up></i>', closed: '<i class=icon-arrow-down></i>'}">
                    <badger-accordion-item>
                        <template slot="header">Tahapan Interverensi Desa</template>    
                        <template slot="content">
                            <ul class="check-list-tracking">
                                ...
                                <li>Pabrik berbasis masyarakat di lokasi intervensi budi daya bambu</li>
                    ...
                    <badger-accordion-item>
                        ...
                        <template slot="content" style="max-width=100% !important">
                            <div class="tracking-wrapper">
                                <div class="tracking-label">Kebun bibit keluarga</div><div class="tracking-value">3.5 hektar</div>
                                <div class="tracking-label">Kebun Semai</div><div class="tracking-value">4 hektar</div>
                                <div class="tracking-label">Kebun Kepompong</div><div class="tracking-value">0.25 hektar</div>
                                <div class="tracking-label">Lahan Pemerintah</div><div class="tracking-value">68.37 hektar</div>
                                <div class="tracking-label">Lahan Swasta / Perorangan</div><div class="tracking-value">2 hektar</div>
                            </div>
                        </template>  
                    </badger-accordion-item>
                    ...
                    <badger-accordion-item>
                      <template slot="header">Jumlah Rumpun / Tegakan</template>    
                        <template slot="content" style="max-width=100% !important">
                          ...
                          <div class="tracking-wrapper">
                              <div class="tracking-label">Lahan Pemerintah</div><div class="tracking-value">68.37 hektar</div>
                              <div class="tracking-label">Lahan Swasta / Perorangan</div><div class="tracking-value">3 hektar</div>
                          </div>
                          <br>
                    ...
                    <badger-accordion-item>
                      <template slot="header">Jumlah Bibit, Kepompong dan Detail Pembibit</template>    
                      <template slot="content" style="max-width=100% !important">
                        <div class="tracking-wrapper">
                            <div class="tracking-label">Total Target</div><div class="tracking-value">20.000</div>
                            <div class="tracking-label">Total Komitmen</div><div class="tracking-value">25.000</div>
                            <div class="tracking-label">Total Cabang yang ditanam</div><div class="tracking-value">25.000</div>
                            <div class="tracking-label">Kebun Bibit Keluarga</div><div class="tracking-value">18.000</div>
                            <div class="tracking-label">Kebun Semai</div><div class="tracking-value">10.000</div>
                            <div class="tracking-label">Persemaian</div><div class="tracking-value">10.000</div>
                        </div>
                        <br><br>
                        <k-tabs>
                    ...
                    <badger-accordion-item>
                      ...
                      <template slot="content" style="max-width=100% !important">
                        <div class="tracking-wrapper">
                            <div class="tracking-label">Kebun bibit keluarga</div><div class="tracking-value">20.000</div>
                            <div class="tracking-label">Kebun Semai</div><div class="tracking-value">25.000</div>
                            <div class="tracking-label">Kebun Kepompong</div><div class="tracking-value">25.000</div>
                            <div class="tracking-label">Lahan Pemerintah</div><div class="tracking-value">18.000</div>
                            <div class="tracking-label">Lahan Swasta</div><div class="tracking-value">10.000</div>
                        </div>
                        <div><hr></div>
                        <div class="tracking-wrapper">
                            <div class="tracking-label">Total Bibit </div><div class="tracking-value">10.000</div>
                        </div>
                        <br><br>
                        <div v-if="jml_penanaman > 0 && ((jml_kepompong > 0 || luas_kepompong > 0) || (jml_bibit > 0 || luas_lahan > 0))"></div>
                    ...
                    <badger-accordion-item>
                      <template slot="header">Jumlah Beneficiaries ( Individu / KTH )</template>    
                      <template slot="content" style="max-width=100% !important">
                        <div class="tracking-wrapper">
                            <div class="tracking-label">Kebun bibit keluarga</div><div class="tracking-value">20.000</div>
                            <div class="tracking-label">Kebun Semai</div><div class="tracking-value">25.000</div>
                    ...
                    <badger-accordion-item>
                      ...
                      <template slot="content" style="max-width=100% !important">
                        <div class="tracking-wrapper">
                            <div class="tracking-label">Individu</div><div class="tracking-value">355</div>
                            <div class="tracking-label">Kelompok</div><div class="tracking-value">25.000</div>
                            <div class="tracking-label">Stakeholder</div><div class="tracking-value">5</div>
                        </div>
                      </template>
                    </badger-accordion-item>

                    <badger-accordion-item>
                        <template slot="header">Jumlah dan Kualitas Tanaman Sela Lokal</template>    
                        <template slot="content">
                            <ul class="check-list-tracking">
                    ...
                    <badger-accordion-item>
                      <template slot="header">Peningkatan Kontribusi Penyerapan Karbon</template>    
                      <template slot="content">
                        <div class="tracking-wrapper">
                            <div class="tracking-label">Estimasi potensi kandungan karbon</div><div class="tracking-value">0,35</div>
                            <div class="tracking-label">Persentase karbon di dalam biomassa</div><div class="tracking-value">45,.63</div>
                            <div class="tracking-label">Model persamaan alometrik yang efektif</div><div class="tracking-value">AGB= 0.055 ×D^2.584</div>
                        </div>
                      </template>
                    </badger-accordion-item>
                    ...
                    <badger-accordion-item>
                        ...
                        <template slot="content">
                            <ul class="check-list-tracking">
                                ...
                                <li>Kebijakan supra desa; kecamatan, kabupaten, provinsi dan nasional yang bersifat formal.</li>
                                <li>Tata kelola hutan,lahan dan lingkungan terkait bambu; 1. kebijakan mekanisme perhutanan sosial yang memasukkan bambu; sk perhutanan sosial.</li>
                                <li>Kebijakan anggaran publik; kebijakan dana desa, kebijakan fiskal (EFT), kebijakan dana reboisasi dan kebijakan lain terkait anggaran publik untuk desa bambu.</li>
                                <li>Kebijakan perencanaan pembangunan; kebijakan perencanaan desa, kabupaten, provinsi dan nasional.</li>
                            </ul>
                        </template>  
                    </badger-accordion-item>
