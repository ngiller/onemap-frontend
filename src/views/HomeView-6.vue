  ...
  methods: {
    ...
    getDesaBambu: async function (file_type) {
      ...
      let filename = ''
        ...
        for(var i=0; i< this.desa_bambu.length; i++){
          if (this.desa_bambu[i].file_type == file_type) {
    ...
    getData: async function () {
        ...
        for(var i=0; i< this.desa_bambu.length; i++){
          ...
          if (prop_name != this.desa_bambu[i].nama_pulau) {
            if (prop_name != '') {
              this.treeDataPembibitan.push({prop_id: this.desa_bambu[i].prop_id, name: prop_name, propinsi: true, kabupaten: false, kab_id: 0, kecamatan: false, desa: false, lat: lat, lng: lng, des_id: this.desa_bambu[i].des_id, children: kab})
              kab = []
            }
        ...
        this.treeDataPembibitan.push({prop_id: prop_id, name: prop_name, propinsi: true, kabupaten: false, kab_id: '0', kecamatan: false, desa: false, lat: lat, lng: lng, des_id: des_id, children: kab})
