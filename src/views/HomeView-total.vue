        ...
        <div class="container">
                  ...
                  <k-tab name="PROGRESS" :selected="true">
                    ...
                    <div  v-if="jml_bibit > 0">
                      <div class="content-area">
                        <div class="label-content" style="margin-top:10px"><b>Tahun</b></div>
                        <div class="answer-content" style="padding-top:10px"><b>Jumlah Bibit</b></div>
                        <div class="answer-last-content" style="padding-top:10px"><b>Luas</b></div>
                      </div>
                      <hr>
                      <div v-for="(item, x) in data_pembibitan"  :key="x">
                        <div class="content-area">
                          ...
                          <div class="answer-last-content" v-if="item.luas > 0"> {{ item.luas | numberFormat }} m2</div>
                        </div>
                      </div>
                    </div>
                    <hr></hr>
                    <div class="content-area" style="margin-top:10px;" >
                      <div class="label-content"><b>TOTAL :</b></div>
                      <div class="answer-content" v-if="jml_bibit > 0"> <b>{{jml_bibit | numberFormat}} bibit</b></div>
                      <div class="answer-last-content" v-if="luas_lahan > 0"> <b>{{ luas_lahan | floatFormat }} m2</b></div>
                    </div>
          ...
          <div class="layer-panel" v-if="viewLayer">
            <form>
              ...
              <figure style="float:left; margin:0; width:80px;">
                  <label class="label-map">
                      <input type="checkbox" id="critical" value="critical" v-model="checkedArea" @change="aditionalLayerClick">
                      <img src="../../public/img/critical-layer.jpg"  class="layer-img" />
                      <figcaption class="item-label">Critical</figcaption>
                  </label>
              </figure>
...
export default {
  ...
  methods: {
    ...
    aditionalLayerClick() {
      if (this.checkedArea[0] == 'critical') {
        ...
        for(var i=0; i< this.desa_bambu.length; i++){
          ...
          if ((kab_filename != this.desa_bambu[i].geojson_kabupaten) && this.desa_bambu[i].geojson_kabupaten != '') {
              if (this.desa_bambu[i].geojson_kabupaten) { 
                ...
                //kab_geojson = await this.getGeoJsonFile('ende.geojson')
