              ...
              <div class="panel-right-content">
                ...
                <k-tabs>
                  <k-tab name="PROGRESS" :selected="true">
                    ...
                    <hr class="yearSelectLine" />
                    <div class="content-area" style="margin-top:10px;" v-if="jml_bibit > 0">
                      <!---------------------->
                      <label class="label-content" style="padding-top:10px">Select Year</label>
                      <div class="answer-content">
                        <multiselect v-model="yearSelect" :options="yearSelectList" :multiple="true" :close-on-select="false" :clear-on-select="false" :preserve-search="true" placeholder="Pilih tahun" label="name" track-by="name">
